 ...
 */
export function generateUniqueReference(prefix = "REF", length = 8) {
 ...
 */
export function generateAlphanumericReference(length = 12) {
 ...
 */
export function generateMonifyReference() {
