...
export const CHAIN_TOKEN_CONFIG = {
    ethereum: {
        chainId: 1,
...
export class TokenConfigUtils {
     ...
     */
    static getTokenAddress(chain, tokenSymbol) {
     ...
     */
    static getTokenInfo(chain, tokenSymbol) {
        const chainConfig = CHAIN_TOKEN_CONFIG[chain.toLowerCase()];
        if (!chainConfig)
            return null;
     ...
     */
    static getChainTokenAddresses(chain) {
     ...
     */
    static getChainTokenSymbols(chain) {
        const tokens = this.getChainTokens(chain);
        if (!tokens)
            return [];
     ...
     */
    static isTokenSupported(chain, tokenSymbol) {
     ...
     */
    static findTokenByAddress(address) {
     ...
     */
    static formatTokenAmount(amount, chain, tokenSymbol) {
